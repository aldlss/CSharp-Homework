...
namespace AyaTools
{
    ...
    internal class DelegationButtonAsync : ICommand
    {
        public event EventHandler? CanExecuteChanged;
        ...
        public DelegationButtonAsync(Func<object?, Task> executeEvent, TimeSpan waitTime , Predicate<object?>? canExecuteEvent = null)
        {
            _waitTime = waitTime;
            ExecuteEvent = executeEvent;
            CanExecuteEvent = canExecuteEvent;
